...
describe('fernet.Token.prototype.decode', function () {
  ...
  it("decode(token) with top-level secret", function () {
  ...
  it('inherits parent TTL', function () {
  ...
  it('raises new Error("Invalid Token: TTL") on invalid ttl', function () {
  ...
  it('raises new Error("Invalid version") on wrong version byte', function () {
  ...
  it('raises new Error("Invalid Token: HMAC") on wrong Hmac', function () {
  ...
  it('raises new Error("far-future timestamp") on unacceptable clock skew', function () {
    var token = new fernet.Token({
